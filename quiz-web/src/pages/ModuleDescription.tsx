...
const ModuleDescription: React.FC = () => {
  ...
  if (loading) {
    return <div className="text-center py-10 text-gray-600">Loading module details...</div>;
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            {/* Learning Outcomes */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 mb-3">Learning Outcomes</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h2 className="text-xl font-semibold text-gray-800 mb-3">Topics Covered</h2>
              ...
              <div>
                <h2 className="text-xl font-semibold text-gray-800 mb-3">Assessment Methods</h2>
